...
- \textcolor{red}{Gap in high blood pressure treatment!}
  - **Hypertension control**: Among the 20,409 participants with stage 2 hypertension, 54% are uncontrolled.
  - **Awareness**: Among those with hypertension, 80% of them are aware of their condition.
  - **Treatment**: Among those aware, 90% of them are taking medication.
- $0.80\times 0.90\approx 72\%$ of those with stage 2 hypertension are being medicated.
...
knitr::include_graphics("./result_files/table2_v2.png")
```
...
6. Little, R.A. and Rubin, D.B. (2019). Statistical Analysis with Missing Data, Third Edition. Chapman and Hall/CRC.
