...
## Results
- \textcolor{red}{Significant gap} in high blood pressure treatment!
...
knitr::include_graphics("./result_files/table1m.png")
```
...
knitr::include_graphics("./result_files/m_plot2.png")
```
