...
```{r}
imputation.svy_subset<-subset(imputation.svy,bp_uncontrolled_140_90 == 1)
```

### awareness
```{r}
model2 <- lm_svy_mi(htn_aware~svy_year+demo_age_years+demo_race+female+cc_bmi+cc_diabetes+cc_ckd+cc_cvd_any, imputation.svy_subset,imputations)
...
### med use
```{r}
imputation.svy_subset1<-subset(imputation.svy_subset,htn_aware == 1)
...
write.csv(res_m2, "./result_files/res_m2.csv")
write.csv(res_m3, "./result_files/res_m3.csv")
```
