...
# 9 predictors
model3 <- lm_svy_mi(bp_uncontrolled_140_90 ~ demo_age_years + demo_race + female + cc_bmi + cc_diabetes 
                    + cc_ckd + cc_cvd_any + bp_med_use + htn_aware, imputations)

# Stage 1 Hypertension
#now lets try the model out
model_s1 <- lm_svy_mi(bp_uncontrolled_130_80 ~ svy_year + demo_age_years + demo_race + female + cc_bmi + 
                        cc_diabetes + cc_ckd + cc_cvd_any + bp_med_use + htn_aware + cc_smoke, imputations)
model_s1
```
...
# stage 1 hypertension
screenreg(convertModel(models1))
```
